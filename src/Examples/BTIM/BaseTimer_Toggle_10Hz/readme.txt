...
硬件资源：
          ...
          2. 时钟HSE，16MHz
          3. 系统时钟设置为PLL时钟，为HSE频率的4倍频，64MHz， PCLK、HCLK不分频，
             PCLK=HCLK=SysClk=64MHz
          4. BTIM1的时钟设置为PCLK，1024分频，
          5. PA07,PA09,PA10设置为PUSH-PULL输出, 复用为BTIM1的TOG输出
          6. PB09设置为PUSH-PULL输出
          7. PB08设置为PUSH-PULL输出



演示说明：
          BTIM1的计数时钟为64MHz/1024=62500Hz，设置ARR寄存器为62500 / 20 - 1，BTIM1每50ms溢出一次；
