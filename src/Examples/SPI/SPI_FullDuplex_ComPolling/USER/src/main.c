...
//SPIz GPIO
#define  SPIz_GPIO_CLK                  RCC_AHB_PERIPH_GPIOB
...
void RCC_Configuration(void)
{
    ...
    //外设时钟使能
    RCC_AHBPeriphClk_Enable(SPIy_GPIO_CLK | SPIz_GPIO_CLK | RCC_AHB_PERIPH_GPIOB, ENABLE);
